...
In preparing this thesis, I used Claude by Anthropic to generate initial drafts and expand on ideas, providing valuable suggestions and examples. I further utilized it for grammar and style correction across all sections, ensuring clarity and coherence in my writing. Additionally, I used GitHub Copilot to generate code snippets for the developed functionality and code snippets. I have carefully checked all code and texts created with these tools to ensure that they are correct and make sense.
